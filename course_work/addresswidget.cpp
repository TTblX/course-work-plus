...
void AddressWidget::showAddEntryDialog()
{
    ...
    if (aDialog.exec())
        addEntry(aDialog.name(), aDialog.address(), aDialog.email());
}
//! [2]

//! [3]
void AddressWidget::addEntry(const QString &name, const QString &address, const QString &email)
{
...
//! [4b]
    ...
    aDialog.editAddress(name, address, email);
...
void AddressWidget::readFromFile(const QString &fileName)
{
    ...
    if (contacts.isEmpty()) {
        ...
        for (const auto &contact: qAsConst(contacts))
            addEntry(contact.name, contact.address, contact.email);
    }
}
//! [7]
